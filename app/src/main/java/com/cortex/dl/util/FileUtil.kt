...
private const val PRIVATE_DIRECTORY_SUFFIX = ".CortexDL"
...
object FileUtil {
    ...
    fun getExternalTempDir() =
        File(context.getExternalFilesDir(null) ?: context.filesDir, "tmp").apply {
            mkdirs()
    ...
    internal fun getExternalDownloadDirectory() =
        File(Environment.getExternalStoragePublicDirectory(Environment.DIRECTORY_DOWNLOADS), "CortexDL")
            .also { it.mkdir() }
