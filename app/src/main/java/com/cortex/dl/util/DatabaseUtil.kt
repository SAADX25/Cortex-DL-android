...
import com.cortex.dl.App.Companion.applicationScope
import com.cortex.dl.App.Companion.context
import com.cortex.dl.database.AppDatabase
import com.cortex.dl.database.backup.Backup
import com.cortex.dl.database.backup.BackupUtil.BackupType
import com.cortex.dl.database.backup.BackupUtil.decodeToBackup
...
object DatabaseUtil {
    ...
    suspend fun unhideItem(info: DownloadedVideoInfo) {
        ...
        if (hiddenFile.exists()) {
            // Restore to the original Cortex DL download directory
